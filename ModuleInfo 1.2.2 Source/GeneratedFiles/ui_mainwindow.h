...
"font:13px '\345\276\256\350\275\257\351\233\205\351\273\221';\n"
"color:white"));
        data_save_box = new QWidget(hmd_exec_area);
        data_save_box->setObjectName(QStringLiteral("data_save_box"));
        data_save_box->setGeometry(QRect(310, 5, 115, 85));
        data_save_box->setStyleSheet(QString::fromUtf8("#data_save_box{\n"
"border:1 solid #FF333333;\n"
"font:13px '\345\276\256\350\275\257\351\233\205\351\273\221';\n"
"color:white\n"
"}"));
        imu_data = new QCheckBox(data_save_box);
        imu_data->setObjectName(QStringLiteral("imu_data"));
        imu_data->setGeometry(QRect(10, 10, 100, 16));
        imu_data->setStyleSheet(QString::fromUtf8("font:13px '\345\276\256\350\275\257\351\233\205\351\273\221';\n"
"color:white"));
        camera_data = new QCheckBox(data_save_box);
        camera_data->setObjectName(QStringLiteral("camera_data"));
        camera_data->setGeometry(QRect(10, 30, 100, 16));
        camera_data->setStyleSheet(QString::fromUtf8("font:13px '\345\276\256\350\275\257\351\233\205\351\273\221';\n"
"color:white"));
        collect_start = new QPushButton(data_save_box);
        collect_start->setObjectName(QStringLiteral("collect_start"));
        collect_start->setGeometry(QRect(5, 50, 105, 31));
...
"}"));
    ...
    {
        MainWindow->setWindowTitle(QApplication::translate("MainWindow", "\346\250\241\347\273\204\344\277\241\346\201\257\351\207\207\351\233\206 1.2.2", nullptr));
        module_title->setText(QApplication::translate("MainWindow", "INDEMIDE  MODULE-INFO COLLECT 1.2.2", nullptr));
        ...
        IMU_CAMERA_INFO->setText(QApplication::translate("MainWindow", "<html><head/><body><span style=\" color:#ffffff;\"><p>\346\250\241\347\273\204\350\256\276\345\244\207 <b style=\" color:#39F354;\">IMU | \347\233\270\346\234\272\346\226\207\344\273\266</b> </p></body></html>", nullptr));
